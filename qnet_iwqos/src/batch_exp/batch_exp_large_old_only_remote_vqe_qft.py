        ...
        for file in files:
            if file.endswith('.qasm'):
                ...
                for i in range(num_sample):
                    path_write = '../exp_data/baseline_0221_unweighted_only_remote/' + scale + '/' + circuitname + '_shortest_path_' + "_trivial_allocation" + "_bandwidth_" + str(qubit_per_channel) + '_old_' + '.txt'
                    print(path_write)
